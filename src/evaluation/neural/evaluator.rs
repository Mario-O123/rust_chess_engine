...
mod tests {
    ...
    fn eval_random_pos(){
        ...
        let pos = Position::from_fen("2r1N3/2P5/1b1rkp2/B1P1Pp2/1R1p4/5N2/6B1/K7 w - - 0 1").unwrap();
    ...
    fn eval_random_pos_2(){
        ...
        let pos = Position::from_fen("2B1k3/5N2/P5p1/BpK1p2R/2b1P3/5r2/P5P1/5n2 w - - 0 1").unwrap();
    ...
    fn eval_random_pos_3(){
        ...
        let pos = Position::from_fen("r3k2r/pn1b1p1p/6p1/1Pp1P3/6n1/P4N2/2P2PPP/R3KB1R w KQkq - 0 16").unwrap();
    ...
    fn eval_random_pos_4(){
        ...
        let pos = Position::from_fen("rnb1k2r/pp3pbp/1N1ppnp1/2pP4/4P3/3Q1N2/PPP2PPP/R1B1KB1R b KQkq - 0 8").unwrap();
