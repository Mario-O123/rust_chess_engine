...
use crate::position::{Position, Cell, Color, Piece, PieceKind};
...
match position.board[king_from] {
    ...
    Cell::Piece(Piece { color : Color::White , kind : PieceKind::King}) => {
        ...
        && matches!(position.board[91], Cell::Piece(Piece {kind: PieceKind::Rook, color: Color::White}))
        && is_square_attacked(position, king_from, Color::Black) == false && is_square_attacked(position, 94, Color::Black) == false
        && is_square_attacked(position, 93, Color::Black) == false && is_square_attacked(position, 92, Color::Black) == false
        ...
        && matches!(position.board[98], Cell::Piece(Piece {kind: PieceKind::Rook, color: Color::White}))
        && is_square_attacked(position, king_from, Color::Black) == false && is_square_attacked(position, 96, Color::Black) == false
        && is_square_attacked(position, 98, Color::Black) == false && is_square_attacked(position, 97, Color::Black) ==false
        {
    ...
    Cell::Piece(Piece {color : Color::Black , kind : PieceKind::King}) => {
        ...
        && matches!(position.board[21], Cell::Piece(Piece {kind: PieceKind::Rook, color: Color::Black}))
        && is_square_attacked(position, king_from, Color::White) == false && is_square_attacked(position, 24, Color::White) == false
        && is_square_attacked(position, 23, Color::White) == false && is_square_attacked(position, 22, Color::White) == false
        ...
        && matches!(position.board[28], Cell::Piece(Piece {kind: PieceKind::Rook, color: Color::Black}))
        && is_square_attacked(position, king_from, Color::White) == false && is_square_attacked(position, 26, Color::White) == false
        && is_square_attacked(position, 28, Color::White) == false && is_square_attacked(position, 27, Color::White) == false{
