...
mod tests {
    ...
    fn attackers_of_square_returns_all_attackers() {
        ...
        let mut attackers = attackers_of_square(&pos, target, Color::White);
        attackers.sort_unstable();

        let mut expected = vec![d4, f3];
    ...
    fn is_in_check_rook_file() {
        ...
        pos.king_sq[Color::Black.idx()] = e8 as u8;
    ...
    fn find_king_finds_correct_square() {
        ...
        assert_eq!(find_king(&pos, Color::White), Some(g2));
